...
2. Click **"Use this template"** → **"Create a new repository"**
   ...
   <img width="1267" alt="Screenshot 2026-01-13 at 7 28 19 PM" src="https://github.com/user-attachments/assets/04dd7645-7f8b-4294-97eb-0405915cc747" />
...
1. Navigate to [DA.live](https://da.live/start)
   ...
   <img width="300" alt="image" src="https://github.com/user-attachments/assets/67d6b5f5-d036-41bc-a251-6a30518f143a" />

2. Add your newly created github repository link
3. Select the **No Sample Content** option.

   <img width="300" alt="image" src="https://github.com/user-attachments/assets/cdb2264d-1150-4516-ae0b-b0a72c366c40" />

4. We should now have an empty content space create for the site.

   <img width="300" alt="image" src="https://github.com/user-attachments/assets/5167c77f-67ac-43e4-949e-04b347e43fe3" />
...
6. In the **Org** field, enter your organization name and in **Site** field, enter your repository name.
   - For example: If your DA.live URL is `https://da.live/#/meejain/zeroto100`, then:
     ...
     - **Site**: `zeroto100`
      ...
      <img width="400" alt="image" src="https://github.com/user-attachments/assets/5cb9d167-5e45-43b1-9e8c-aa4feaf16635" />
...
8. You should now see the content imported for your site at https://da.live/#/<org>/<repo>
   ...
   <img width="400" alt="image" src="https://github.com/user-attachments/assets/df996783-2dad-44d6-a522-1ef35562710d" />
...
4. After successful configuration, you should see the Helix and DA MCP servers available and enabled.
   ...
   <img width="1028" alt="Screenshot 2026-01-13 at 7 46 55 PM" src="https://github.com/user-attachments/assets/f2cba43a-98f3-49e7-bc24-ee22861dc110" />
...
4. Enable `da-live-admin` and `helix-mcp-server`
   ...
   <img width="610" alt="image" src="https://github.com/user-attachments/assets/8baa6d3a-b2b3-4868-b5b8-281faf2180f7" />
